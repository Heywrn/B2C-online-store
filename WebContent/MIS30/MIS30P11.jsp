...
<table width="581" height="262" border="10" align="center" bordercolor="#999999" bgcolor="#F0F0F0">
  <form name="form1" method="post" action="MIS30P12.jsp">
  <br>
  <br>
  <br>
  <br>
  ...
  <tr>
    <td><div align="center" class="STYLE2">还书日期：</div></td>
    <td>
 <div align="center">
        <input name="hsrq" type="text" class="STYLE2" id="hsrq" value="${requestScope.d} ">
      </div>  </td>
  </tr>
  <tr>
    <td class="STYLE2"><div align="center">是否损坏：</div></td>
    <center><td><label>
      <span class="STYLE2">
      <input type="radio" name="sh" value="1">
    是</label> <label>
      <span class="STYLE2">
    <input type="radio" name="sh" value="0" checked>
    否</label></td></center>
  </tr>
  <tr>
    <td colspan="2">
