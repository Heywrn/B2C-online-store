...
<div id="con">
  <div id="Layer1">
    <div class="c_r">
      <p><a href="login.jsp" target="mainFrame" class="STYLE3">登录</a><a href="register.jsp" target="mainFrame">注册</a></p>
    </div>
  </div>
  <div class="c_r c" >
		<p><a href="order.jsp" target="mainFrame" class="STYLE3">订单信息</a><a href="deliver.jsp" target="mainFrame">配送信息</a>
